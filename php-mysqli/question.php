...
<script>
function laporPertanyaan(idPertanyaan) {
    $.post('lapor.php', {type: 'pertanyaan', id: idPertanyaan}, function(response) {
        alert('Laporan telah dikirim.');
    });
}
function laporJawaban(idJawaban) {
    $.post('lapor.php', {type: 'jawaban', id: idJawaban}, function(response) {
        alert('Laporan telah dikirim.');
    });
}
</script>
        ...
        if ($result) {
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<button onclick='laporPertanyaan(" . $row['idpertanyaan'] . ")'>Lapor</button>";
                    ...
                    if ($result2) {
                        if ($result2->num_rows > 0) {
                            ...
                            while ($row2 = $result2->fetch_assoc()) {
                                ...
                                echo "<button onclick='laporJawaban(" . $row2['idjawaban'] . ")'>Lapor</button>";
