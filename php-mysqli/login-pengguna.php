...
<body>
    <div class="login-container">
        ...
        <p style="margin-bottom: 1px;">Belum daftar? <a href="index.php">Daftar di sini</a></p>
        <p style="margin-bottom: 1px;">Login Sebagai Admin? <a href="loginadmin.php">masuk di sini</a></p>
